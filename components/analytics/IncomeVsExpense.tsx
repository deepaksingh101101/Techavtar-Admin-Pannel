    ...
    <>
      ...
      <div className="mt-6">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-4">
          ...
          <div>
            <label htmlFor="vendor" className="block text-sm font-medium text-gray-400">Vendor</label>
            <select id="vendor" className="bg-gray-800 text-gray-400 text-sm border border-gray-700 rounded-md px-2 py-1 w-full">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-gray-900 p-4 rounded-md">
            ...
            <p className="text-lg font-semibold text-white">Income Vs Expense Summary</p>
          </div>
          <div className="bg-gray-900 p-4 rounded-md">
